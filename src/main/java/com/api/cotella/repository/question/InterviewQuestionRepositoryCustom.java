...
public interface InterviewQuestionRepositoryCustom {
  ...
  List<InterviewQuestion> findRandomTechQuestions(InterviewKeywordContent interviewKeywordContent);

  List<InterviewQuestion> findRandomFitQuestions(InterviewKeywordContent interviewKeywordContent);
